...
const ACTIONS=[
  {id:"train_body",phases:["academy","firstteam","overseas","campus","pro"],icon:"»",name:"身体训练",desc:"冲刺、折返、力量与核心——用乳酸换更快的第一步和更稳的对抗。",effects:["速度↑","爆发↑","耐力/对抗↑","体能↓"],max:2,run:s=>{gainStat(s,"speed",.55,"speed");gainStat(s,"burst",.5,"burst");gainStat(s,"stamina",.35,"stamina");gainStat(s,"height",.3,"height");change(s,"fitness",-13);fatigueInjuryCheck(s,.04)}},
